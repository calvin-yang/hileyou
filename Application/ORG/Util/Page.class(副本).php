...
class Page {
    ...
    public function show() {
        ...
        if ($upRow>0){
            ...
            $upPage     =   "<li class='previous disabled'><a href='".str_replace('__PAGE__',$upRow,$url)."'>".$this->config['prev']."</a></li>";
        }

        if ($downRow <= $this->totalPages){
            $downPage   =   "<li class='next'><a href='".str_replace('__PAGE__',$downRow,$url)."'>".$this->config['next']."</a></li>";
        }else{
            $downPage   =   "<li  class='next disabled'><a href='".str_replace('__PAGE__',$downRow,$url)."'>".$this->config['next']."</a></li>";
        }
        // << < > >>
        if($nowCoolPage == 1){
