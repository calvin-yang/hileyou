...
use Facilitator\Model\AuthRuleModel;
use Facilitator\Model\AuthGroupModel;
/**
 * 后台首页控制器
...
class FacilitatorController extends Controller {
     ...
     */
    protected function falsestatus ( $model , $where = array() , $msg = array( 'success'=>'操作成功，请发送信息给服务商', 'error'=>'操作失败！')) {
        $data['status']         =   4;
        $data['update_time']    =   NOW_TIME;
        $this->editRow(   $model , $data, $where, $msg);
    }
