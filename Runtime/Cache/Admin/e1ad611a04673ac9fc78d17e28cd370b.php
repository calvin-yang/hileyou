...
<body>
	...
	<div class="cf">
		<div class="fl">
            <a class="btn" href="<?php echo U('Message/sendmsg');?>">发送系统消息</a>
        ...
        <div class="search-form fr cf">
			<div class="sleft">
				<div class="drop-down">
					<span id="sch-sort-txt" class="sort-txt" data="<?php echo $_GET['type'];?>"><?php if(get_status_title($_GET['type']) == ''): ?>所有<?php else: echo ($_GET['type'] == 2)?'系统':'普通'; endif; ?></span>
				...
				<input type="text" name="title" class="search-input" value="<?php echo I('title');?>" placeholder="请输入发件人">
    ...
    <tbody>
		<?php if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<td><?php echo empty($vo['sender_mobile'])?$vo['sender_nickname']:$vo['sender_mobile'];?></td>
			<td><?php echo ($vo["receiver_mobile"]); ?></td>
			<td><div class="ms-<?php echo $vo['id'];?>" style="display:none;"><?php echo ($vo["message_text"]); ?></div><div><a href="javascript:showBg(<?php echo $vo['id'];?>);"><?php echo ($vo['type'] == 1)?str_cut($vo['message_text'],30):str_cut($vo['message_title'],30);?></a></div></td>
			<td><?php echo ($vo['type'] == 1)?'普通':'系统';?></td>
    ...
    //导航高亮
    $('.side-sub-menu').find('a[href="<?php echo U('message/index');?>"]').closest('li').addClass('current');
	</script>
