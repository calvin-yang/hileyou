...
<body>
    ...
    <form action="/index.php?s=/product/rmadd.html" method="post" class="form-horizontal">
                   ...
                   <div class="demo">
                        <div class="btn">
                            <span class="up_str">上传图片</span>
                             <span class="img_up"><input type="file" name="img" upUrl="<?php echo U('Product/imgUplode');?>" at="logo_img_url" onchange="img_upload(this,'1');"></span>
            ...
            <div class="controls">
                <div id="main">
                   <div class="demo">
                        <div class="btn">
                            <span class="up_str">上传图片</span>
                            <span class="img_up"><input type="file" name="img" upUrl="<?php echo U('Product/imgUplode');?>" at="hel_img_url" dele="" onchange="img_upload(this,'2');"></span>
                            <input id="hel_img_url" type="hidden" name="hel_img_url" />
                        </div>
                        <div class="progress">
                            <span class="bar"></span><span class="percent">0%</span >
                        </div>
        ...
        <div class="form-item cf">
            ...
            <div class="controls">
                <input type="text" class="text input-large " name="hel_name" value="">
            </div>
        </div>
        ...
        <div class="form-item cf">
            ...
            <div class="controls">
                <input type="text" class="text input-large " name="hel_tel" value="">
            </div>
        </div>
        ...
        <div class="form-item cf">
            ...
            <div class="controls">
                <input type="text" class="text input-large " name="max_man" value="">
            </div>
        </div>
        ...
        <div class="form-item cf">
            ...
            <div class="">
                ...
                <!-- <select style="width: 300px" class="chzn-select" id="facilities" name="facilities"> -->
                <!-- <select name="mobile"> -->
                    <?php if(is_array($facilities_list['name'])): $i = 0; $__LIST__ = $facilities_list['name'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo); ?>"><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
        ...
        <div class="form-item cf">
            ...
            <div class="controls">
                <input type="number" class="text input-large " name="bedroom" value="0">
            </div>
        </div>
        ...
        <div class="form-item cf">
            ...
            <div class="controls">
                <input type="number" class="text input-large " name="toilet" value="1">
            </div>
        </div>
        ...
        <div class="form-item cf">
            ...
            <div class="controls">
                <input type="number" class="text input-large " name="bed" value="1">
            </div>
        </div>
        ...
        <div class="form-item cf">
            ...
            <div class="controls">
                <input type="number" class="text input-large price" name="day_price" value="0">
            </div>
        </div>
        ...
        <div class="form-item cf">
            ...
            <div class="controls">
                <input type="number" class="text input-large " name="deposit" value="0">
            </div>
        </div>
        ...
        <div class="form-item cf">
            ...
            <div class="controls">
                <input type="time" class="text input-large " name="check_in" value="00:00">
            </div>
        </div>
        ...
        <div class="form-item cf">
            ...
            <div class="controls">
                <input type="time" class="text input-large " name="check_out" value="12:00">
            </div>
        </div>
        ...
        <div class="form-item cf">
            ...
            <div class="controls">
                <div class="radio">
                  <label>
                    <input type="radio" name="tel_status" id="type" value="0">
                    &nbsp;无房
                  </label>&nbsp;&nbsp;&nbsp;&nbsp;
                  <label>
                    <input type="radio" name="tel_status" id="type" value="1" checked>
                    &nbsp;有房
                  </label>&nbsp;&nbsp;&nbsp;&nbsp;
                </div>
