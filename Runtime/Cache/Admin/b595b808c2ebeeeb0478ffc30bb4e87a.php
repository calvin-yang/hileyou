...
<head>
    <meta charset="UTF-8">
    <title><?php echo ((isset($meta_title) && ($meta_title !== ""))?($meta_title):'海乐游后台管理'); ?></title>
...
<body class="index-body">
    ...
    <div id="indexMain" class="index-main">
       ...
       <div class="container-span top-columns cf">
            <dl class="show-num-mod">
                ...
                <dd>
                    <strong><?php echo ($data["member_number"]); ?></strong>
                    <span>用户数</span>
                </dd>
            </dl>
            <dl class="show-num-mod">
                ...
                <dd>
                    <strong><?php echo ($data["vip_member_number"]); ?></strong>
                    <span>VIP用户</span>
                </dd>
            </dl>
            <dl class="show-num-mod">
                ...
                <dd>
                    <strong><?php echo ($data["facilitator_number"]); ?></strong>
                    <span>服务商</span>
                </dd>
            </dl>
            <dl class="show-num-mod">
                ...
                <dd>
                    <strong><?php echo ($data["financial_price"]); ?></strong>
                    <span>平台金额</span>
                </dd>
            </dl>
            <dl class="show-num-mod">
                ...
                <dd>
                    <strong><?php echo ($data["order_number"]); ?></strong>
                    <span>订单数</span>
                </dd>
            </dl>
        </div>
    ...
    <!-- 底部版权 -->
    <div class="cont-ft">
        <div class="copyright"> @2015 <a href="http://www.51xqb.com/">海乐游</a> 广东深圳市海乐游有限公司</div>
    </div>
