...
<body>
	...
	<div class="cf">
		<div class="fl">
            <a class="btn" href="<?php echo U('Home/inforadd',array('type' => 1));?>">新 增</a>
    ...
    <tbody>
		<?php if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<td>
				<a href="<?php echo U('Home/inforedit?type=1&id='.$vo['id']);?>" target="_blank">编辑</a>
	...
	<script type="text/javascript">
    //导航高亮
    $('.side-sub-menu').find('a[href="<?php echo U('home/travel');?>"]').closest('li').addClass('current');
    // 置顶操作
