...
<body>
    ...
    <form action="/index.php?s=/user/edit/uid/50.html" method="post" class="form-horizontal">
        <div class="form-item">
        ...
        <div class="form-item cf">
            ...
            <div class="controls">
                <div id="main">
                   <div class="demo">
                        <div class="btn">
                            <span class="up_str">更新图片</span>
                             <span class="img_up"><input type="file" name="img" upUrl="<?php echo U('User/imgUplode');?>" at="face_max_url" onchange="img_upload(this,'1');"></span>
                            <input id="face_max_url" type="hidden" name="face_max_url" value="<?php echo ($info["face_max_url"]); ?>" />
                        </div>
                        <div class="progress">
                   ...
                   <?php $img_url = getImgUrl($info['face_max_url']); ?>
                   <div class="col-md-12 column" id="showimg"><?php if(!empty($info["face_max_url"])): ?><div style='float: left;margin-left: 5px;'><img src="<?php echo ($img_url[0]['url'])?$img_url[0]['url']:'';?>" width='220px' height = '111px'></div><?php endif; ?></div>
                </div>
            </div>
        </div>
        ...
        <div class="form-item cf">
            ...
            <div class="controls">
                <div class="radio">
                  <label>
                    <input type="radio" name="sex" id="sex" value="0" <?php if(($info['sex']) == "0"): ?>checked<?php endif; ?>>
                    &nbsp;保密
                  </label>&nbsp;&nbsp;&nbsp;&nbsp;
                  <label>
                    <input type="radio" name="sex" id="sex" value="1" <?php if(($info['sex']) == "1"): ?>checked<?php endif; ?>>
                    &nbsp;男
                  </label>&nbsp;&nbsp;&nbsp;&nbsp;
                  <label>
                    <input type="radio" name="sex" id="sex" value="2" <?php if(($info['sex']) == "2"): ?>checked<?php endif; ?>>
                    &nbsp;女
                  </label>&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <input type="text" class="text input-large" name="IDcard" value="<?php echo ($info["IDcard"]); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">手机号<span class="check-tips"></span></label>
            <div class="controls">
                <input type="text" class="text input-large" name="mobile" value="<?php echo $info['mobile'];?>">
            </div>
        </div>
        <div class="form-item">
