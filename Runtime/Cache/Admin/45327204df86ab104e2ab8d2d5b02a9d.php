...
<body>
    ...
    <!-- <form action="/index.php?s=/home/protyp.html" method="post" class="form-horizontal" enctype="multipart/from-data"> -->
    <form action="/index.php?s=/home/protyp.html" method="post" class="form-horizontal" enctype="multipart/form-data">

    
    <?php if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="form-item cf">
            <label class="item-label">
                <?php if(($vo['type']) == "1"): ?>最美住宿<?php endif; ?>
                <?php if(($vo['type']) == "2"): ?>吃货必去<?php endif; ?>
                <?php if(($vo['type']) == "3"): ?>尽情玩耍<?php endif; ?>
                <?php if(($vo['type']) == "5"): ?>美中行走<?php endif; ?>
            ...
            <div class="controls">
                <div id="main">
                   <div class="demo">
                        <div class="btn">
                            <span class="up_str">(上传/更新)图片</span>
                            <span class="img_up"><input type="file" name="img" upUrl="<?php echo U('Home/imgUplode');?>" at="img_url<?php echo ($i); ?>" onchange="img_upload(this,1);"></span>
                            <input id="img_url<?php echo ($i); ?>" type="hidden" name="img_url[]" value="<?php echo ($vo["img_url"]); ?>" />
                            <input type="hidden" name="id[]" value="<?php echo ($vo["id"]); ?>" />
                            <input type="hidden" name="type[]" value="<?php echo ((isset($vo["type"]) && ($vo["type"] !== ""))?($vo["type"]):$i); ?>" />
                        </div>
                        <div class="progress">
                   ...
                   <?php $img_url = getImgUrl($vo['img_url']); ?>
                   <div class="col-md-12 column" id="showimg"><img src="<?php echo ($img_url)?$img_url[0]['url']:'';?>" width="220px" height="111px"></div>
                </div>
            </div>
        </div>
        ...
        <!-- <div class="form-item cf">
            ...
            <div class="controls">
                <input type="text" class="text input-large " name="retitle[]" value="<?php echo ($vo["retitle"]); ?>">*
            </div>
        </div> -->
        ...
        <div class="form-item cf">
            ...
            <div class="controls">
                <div class="radio">
                  <label>
                    <input type="radio" name="status<?php echo ($i); ?>" id="status" value="0" <?php if(($vo["status"]) == "0"): ?>checked<?php endif; ?>>
                    &nbsp;禁用
                  </label>&nbsp;&nbsp;&nbsp;&nbsp;
                  <label>
                    <input type="radio" name="status<?php echo ($i); ?>" id="status" value="1" <?php if($vo['status'] == '' || $vo['status'] == 1): ?>checked<?php endif; ?>>
                    &nbsp;启用
                  </label>&nbsp;&nbsp;&nbsp;&nbsp;
                </div>
    ...
    <script type="text/javascript">
        ...
        //导航高亮
        $('.side-sub-menu').find('a[href="<?php echo U('Home/protyp');?>"]').closest('li').addClass('current');
        // 然后在select元素上启用chose
