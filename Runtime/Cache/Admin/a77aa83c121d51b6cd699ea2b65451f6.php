...
<body>
    ...
    <div class="main-title">
        <h2><?php echo ($info['id']?'编辑':'新增'); ?>后台菜单</h2>
    </div>
    <form action="/index.php?s=/menu/add/pid/180.html" method="post" class="form-horizontal">
        <div class="form-item">
            <label class="item-label">菜单标题<span class="check-tips">（用于后台显示的配置标题）</span></label>
            <div class="controls">
        ...
        <div class="form-item">
            <label class="item-label">菜单URL<span class="check-tips">（Controlle/Method）</span></label>
            <div class="controls">
                <input type="text" class="text input-large" name="url" value="<?php echo ((isset($info["url"]) && ($info["url"] !== ""))?($info["url"]):''); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">上级菜单<span class="check-tips">（支持无限级）</span></label>
            <div class="controls">
                <select name="pid">
        ...
        <div class="form-item">
            <label class="item-label">隐藏<span class="check-tips"></span></label>
            <div class="controls">
