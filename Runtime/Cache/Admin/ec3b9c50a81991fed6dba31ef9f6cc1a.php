...
<body>
    ...
    <div class="main-title">
        <h2><?php echo ($info['id']?'编辑':'新增'); ?>路线</h2>
    </div>
    
    <form action="/index.php?s=/product/readd.html" method="post" class="form-horizontal">
        ...
        <div class="form-item cf">
            ...
            <div class="controls">
                <input type="text" class="text input-large " name="chief" value="">
            </div>
        </div>
        ...
        <div class="form-item cf">
            ...
            <div class="controls">
                <input type="text" class="text input-large " name="day" value="" width="30px;">&nbsp;天&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="text" class="text input-large " name="night" value="" width="30px;">&nbsp;夜
            </div>
        </div>
        ...
        <div class="form-item cf">
            ...
            <div class="controls">
                <input type="text" class="text input-large " name="starting_city" value="">
            </div>
        </div>
        ...
        <div class="form-item cf">
            ...
            <div class="controls">
                <input type="text" class="text input-large " name="set_placc" value="">
            </div>
        </div>
        ...
        <div class="form-item cf">
            ...
            <div class="controls">
                <label class="textarea input-large">
                    <textarea name="traffic_infermation"></textarea>
                </label>
            </div>
        </div>
        ...
        <div class="form-item cf">
            ...
            <div class="controls">
                <label class="textarea input-large">
                    <textarea name="cost_description"></textarea>
                </label>
            </div>
        </div>
        ...
        <div class="form-item cf">
            ...
            <div class="controls">
                <label class="textarea input-large">
                    <textarea name="housed_explain"></textarea>
                </label>
            </div>
        </div>
        ...
        <div class="form-item cf">
            ...
            <div class="controls">
                <input type="text" class="text input-large " name="team_number" value="">
            </div>
        </div>
        ...
        <div class="form-item cf">
            ...
            <div class="controls">
                <input type="text" class="text input-large " name="lowest_team_number" value="">
            </div>
        </div>

        <div class="form-item cf">
            <label class="item-label">有效时间<span class="check-tips">(格式:YYYY-MM-DD|YYYY-MM-DD、0:长期有效)</span></label>
            <div class="controls">
                <input type="text" class="text input-large " name="departure_date" value="0">
            </div>
        </div>

        <div class="form-item cf">
            <label class="item-label">出发日期<span class="check-tips">(格式:YYYY-MM-DD|YYYY-MM-DD、0:不限)</span></label>
            <div class="controls">
                <input type="text" class="text input-large " name="effective_date" value="0">
            </div>
        </div>
        ...
        <div class="form-item cf">
            ...
            <div class="controls">
                <input type="text" class="text input-large " name="insurance" value="">
            </div>
        </div>
        ...
        <div class="form-item cf">
            ...
            <div class="controls">
                <input type="number" class="text input-large " name="favorable_price" value="0">
            </div>
        </div>
        ...
        <div class="form-item">
            ...
            <button class="btn submit-btn ajax-post" id="submit" type="submit" target-form="form-horizontal">下一步</button>
