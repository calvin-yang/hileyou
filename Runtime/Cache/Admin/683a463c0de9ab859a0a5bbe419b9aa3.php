...
<body>
    ...
    <form action="<?php echo $info['id']?U('eatedit'):U('eatadd');?>" method="post" class="form-horizontal">
                   ...
                   <div class="demo">
                        <div class="btn">
                            <span class="up_str">上传图片</span>
                             <span class="img_up"><input type="file" name="img" upUrl="<?php echo U('Product/imgUplode',array('type'=>'eat'));?>" at="logo_img_url" onchange="img_upload(this,'1');"></span>
            ...
            <div class="controls">
                <div id="main">
                   <div class="demo">
                        <div class="btn">
                            <span class="up_str">上传图片</span>
                            <span class="img_up"><input type="file" name="img" upUrl="<?php echo U('Product/imgUplode',array('type'=>'eat'));?>" at="foot_img_url" dele="" onchange="img_upload(this,'2');"></span>
                   ...
                   <div class="col-md-12 column" id="showimg">
                        <?php if($info['foot_img_url'] != ''){ $imgUrl = getImgUrl($info['foot_img_url']); foreach($imgUrl as $hel_img_list){ echo "<div style='float: left;margin-left: 5px;'><span class='dele' img_delete='".U('Product/img_delete')."' protype='eat2' imgurl='foot_img_url' proid='".$hel_img_list['id']."' style='float:right;cursor:pointer;' onclick='img_delete(this);'>删除</span><img src='".$hel_img_list['url']."' class='img' width='220px' height = '111px'></div>"; } } ?>
            ...
            <div class="controls">
                <div id="main">
                   <div class="demo">
                        <div class="btn">
                            <span class="up_str">上传图片</span>
                            <span class="img_up"><input type="file" name="img" upUrl="<?php echo U('Product/imgUplode',array('type'=>'eat'));?>" at="environment_img_url" dele="" onchange="img_upload(this,'2');"></span>
        ...
        <div class="form-item cf">
            ...
            <div class="controls">
                <input type="text" class="text input-large " style="width:100px" name="business_hours1" value="<?php echo ($info["business_hours1"]); ?>">-
                <input type="text" class="text input-large " style="width:100px" name="business_hours2" value="<?php echo ($info["business_hours2"]); ?>">
            </div>
        </div>
        ...
        <div class="form-item cf">
            <label class="item-label">(￥)优惠价<span class="check-tips">(0：无优惠价)</span>
                <?php if($info['voucher'] != ''): ?><input type="number" class="text input-large " name="zhekou" value="<?php echo round($info['favorable_price']/$info['per_capita'],2)*100;?>"  style="width:50px;" oninput="OnInput (this,event)" onpropertychange="OnPropChanged (this,event)">%

                <?php else: ?>
                    <input type="number" class="text input-large " name="zhekou" value="0"  style="width:50px;" oninput="OnInput (this,event)" onpropertychange="OnPropChanged (this,event)" >%<?php endif; ?>
            </label>
            <div class="controls">
        ...
        <div class="form-item cf">
            ...
            <div class="controls">
                <input type="number" class="text input-large" name="voucher" value="<?php echo ($info["voucher"]); ?>" value="">*
            </div>
        </div>
    ...
    <script type="text/javascript">
        ...
        //导航高亮
        $('.side-sub-menu').find('a[href="<?php echo U('Product/eatlist');?>"]').closest('li').addClass('current');
        // 然后在select元素上启用chose
