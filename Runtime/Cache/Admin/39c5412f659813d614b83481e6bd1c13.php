...
<body>
    ...
    <div class="main-title">
        <h2><?php echo ($info['id']?'编辑':'新增'); ?>VIP用户</h2>
    </div>
    
    <form action="/index.php?s=/vip/user_add.html" method="post" class="form-horizontal">
        ...
        <div class="form-item cf">
            ...
            <div class="">
                ...
                <!-- <select name="vip_id"> -->
                    <?php if(is_array($VIPList)): $i = 0; $__LIST__ = $VIPList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
            </div>
        </div>
