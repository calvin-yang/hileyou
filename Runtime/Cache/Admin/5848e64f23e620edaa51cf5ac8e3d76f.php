...
<body>
    ...
    <div class="main-title">
        <h2><?php echo ($info['id']?'编辑':'新增'); ?>类目</h2>
    </div>
    <form action="/index.php?s=/vip/add.html" method="post" class="form-horizontal">
        <div class="form-item">
        ...
        <div class="form-item">
            <label class="item-label">商品折扣<span class="check-tips">（%）</span></label>
            <div class="controls">
                <input type="text" class="text input-large" name="discount" value="">  
            </div>
        </div>

        <div class="form-item cf">
            <label class="item-label">类目描述<span class="check-tips">（输入行为描述）</span></label>
            <div class="controls">
                <label class="textarea input-large"><textarea name="remark"><?php echo ($remark); ?></textarea></label>
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">月价<span class="check-tips">（每个月的价格）￥</span></label>
            <div class="controls">
                <input type="number" class="text input-large" name="monthly_price" value="">
            </div>
        </div>
