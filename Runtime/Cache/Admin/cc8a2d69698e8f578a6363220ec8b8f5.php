...
<body>
	...
	<div class="cf">
		<div class="fl">
            <button class="btn ajax-post confirm" url="<?php echo U('Order/ord_changeStatus',array('method'=>'finish'));?>" target-form="ids">提现完成</button>
		...
		<div class="search-form fr cf">
			<div class="sleft">
				...
				<a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('Order/finanordlist',false);?>"><i class="btn-search"></i></a>
			</div>
    ...
    <tbody>
		<?php if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<td>
				<a href="<?php echo U('finanord_detail',array('pro_order_id'=>$vo['id']));?>">详情</a>
