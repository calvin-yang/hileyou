...
<body>
    ...
    <div class="main-title">
        <h2><?php echo ($info['id']?'编辑':'新增'); ?>服务商用户</h2>
    </div>
    <!-- <form action="/index.php?s=/facilitator/add.html" method="post" class="form-horizontal" enctype="multipart/from-data"> -->
    <form action="/index.php?s=/facilitator/add.html" method="post" class="form-horizontal" enctype="multipart/form-data">

        <div class="form-item cf">
            <label class="item-label">个人/企业<span class="check-tips"></span></label>
            <div class="controls">
                <div class="radio">
                  <label>
        ...
        <div class="form-item cf">
            ...
            <div class="">
                ...
                <!-- <select name="mobile"> -->
                    <?php if(is_array($memberList)): $i = 0; $__LIST__ = $memberList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["mobile"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
            </div>
        </div>
        ...
        <div class="form-item cf">
            ...
            <div class="controls">
                <input type="text" class="text input-large realname" name="realname" value="">
            </div>
        </div>
        ...
        <div class="form-item cf">
            ...
            <div class="controls">
                <input type="text" class="text input-large IDcard" name="IDcard" value="">
        ...
        <div class="form-item cf">
            <label class="item-label">工商注册号码<span class="check-tips"></span></label>
            <div class="controls">
                <input type="text" class="text input-large" name="business_licence" value="">
            </div>
        </div>
        ...
        <div class="form-item cf">
            <label class="item-label">公司电话<span class="check-tips"></span></label>
            <div class="controls">
        ...
        <div class="form-item cf">
            <label class="item-label">运营所在地址<span class="check-tips"></span></label>
            <div class="controls">
        ...
        <div class="form-item cf">
            <label class="item-label">公司运营类型<span class="check-tips"></span></label>
            <div class="controls">
                <input type="text" class="text input-large" name="operations_type" value="">
            </div>
        </div>

        <div class="form-item cf">
            <label class="item-label">身份证正面<span class="check-tips"></span></label>
            <div class="controls">
                <div id="main">
                   <div class="demo">
                        <div class="btn">
                            <span class="up_str">上传证件图片</span>
                            <span class="img_up"><input type="file" name="img" upUrl="<?php echo U('facilitator/imgUplode');?>" at="id_card_positive" onchange="img_upload(this,1);"></span>
                            <input id="id_card_positive" type="hidden" name="id_card_positive" />
                        </div>
                        <div class="progress">
        ...
        <div class="form-item cf">
            <label class="item-label">身份证反面<span class="check-tips"></span></label>
            <div class="controls">
                <div id="main">
                   <div class="demo">
                        <div class="btn">
                            <span class="up_str">上传证件图片</span>
                            <span class="img_up"><input type="file" name="img" upUrl="<?php echo U('facilitator/imgUplode');?>" at="id_card_opposite" onchange="img_upload(this,1);"></span >
                            <input id="id_card_opposite" type="hidden" name="id_card_opposite" />
                        </div>
                        <div class="progress">
                            <span class="bar"></span><span class="percent">0%</span >
                        </div>
        ...
        <div class="form-item cf">
            <label class="item-label">营业执照<span class="check-tips"></span></label>
            <div class="controls">
                <div id="main">
                   <div class="demo">
                        <div class="btn">
                            <span class="up_str">上传营业执照</span> 
                            <span class="img_up"><input type="file" name="img" upUrl="<?php echo U('facilitator/imgUplode');?>" at="business_licence_positive" onchange="img_upload(this,1);"></span >
                            <input id="business_licence_positive" type="hidden" name="business_licence_url" />
                        </div>
                        <div class="progress">
                            <span class="bar"></span><span class="percent">0%</span >
                        </div>
    ...
    <script type="text/javascript">
        ...
        //导航高亮
        $('.side-sub-menu').find('a[href="<?php echo U('facilitator/index');?>"]').closest('li').addClass('current');
        // 然后在select元素上启用chose
        ...
        $("#mobile").change(function(){
            var uid = $(this).val();
            $.ajax({
                url : "<?php echo U('memberInfo');?>",
                data : {"uid" : uid},
                type : 'post',
                dataType : "JSON",
                success : function(data){
                    $(".realname").val(data.info.realname);
                    $(".IDcard").val(data.info.IDcard);
                }
            });
        });
