...
<body>
    ...
    <!-- <form action="/index.php?s=/home/index.html" method="post" class="form-horizontal" enctype="multipart/from-data"> -->
    <form action="/index.php?s=/home/index.html" method="post" class="form-horizontal" enctype="multipart/form-data">
        ...
        <?php if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="form-item cf">
            <label class="item-label">顶部栏<?php echo ($i); ?><span class="check-tips"></span></label>
            <div class="controls">
                <div id="main">
                   <div class="demo">
                        <div class="btn">
        ...
        <u></u><?php endforeach; endif; else: echo "" ;endif; ?>
    ...
    <script type="text/javascript">
        ...
        //导航高亮
        $('.side-sub-menu').find('a[href="<?php echo U('Home/index');?>"]').closest('li').addClass('current');
        // 然后在select元素上启用chose
