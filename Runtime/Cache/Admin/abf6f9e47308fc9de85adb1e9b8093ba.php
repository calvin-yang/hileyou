...
<body>
    ...
    <div class="main-title">
        <h2><?php echo ($info['id']?'编辑':'新增'); ?>景点</h2>
    </div>
    
    <form action="/index.php?s=/product/pyedit/id/2.html" method="post" class="form-horizontal">
            ...
            <div class="controls">
                <div id="main">
                   <div class="demo">
                        <div class="btn">
                            <span class="up_str">上传图片</span>
                             <span class="img_up"><input type="file" name="img" upUrl="<?php echo U('Product/imgUplode',array('type'=>'play'));?>" at="logo_img_url" onchange="img_upload(this,'1');"></span>
                   ...
                   <div class="col-md-12 column" id="showimg">
                       <div style='float: left;margin-left: 5px;'><img src="<?php echo ($img_url)?$img_url[0]['url']:'';?>" width='220px' height = '111px'></div>
                   </div>
                </div>
            </div>
        </div>
            ...
            <div class="controls">
                <div id="main">
                   <div class="demo">
                        <div class="btn">
                            <span class="up_str">上传图片</span>
                            <span class="img_up"><input type="file" name="img" upUrl="<?php echo U('Product/imgUplode',array('type'=>'play'));?>" at="attractions_img_url" dele="" onchange="img_upload(this,'2');"></span>
                            <input id="attractions_img_url" type="hidden" name="attractions_img_url" value="<?php echo ($info["attractions_img_url"]); ?>" />
                        </div>
                        <div class="progress">
                            <span class="bar"></span><span class="percent">0%</span >
                        </div>
                   ...
                   <div class="col-md-12 column" id="showimg">
                       <?php if($info['attractions_img_url'] != ''){ $imgUrl = getImgUrl($info['attractions_img_url']); foreach($imgUrl as $img_list){ echo "<div style='float: left;margin-left: 5px;'><span class='dele' img_delete='".U('Product/img_delete')."' imgurl='attractions_img_url' proid='".$img_list['id']."' style='float:right;cursor:pointer;' onclick='img_delete(this);'>删除</span><img src='".$img_list['url']."' class='img' width='220px' height = '111px'></div>"; } } ?>
                   </div>
                </div>
            </div>
        </div>
        ...
        <div class="form-item cf">
            ...
            <div class="controls">
                <input type="text" class="text input-large " name="play_time" value="<?php echo ($info["play_time"]); ?>">
            </div>
        </div>
        ...
        <div class="form-item cf">
            ...
            <div class="">
                <select  id="type" name="type" class="chzn-select" multiple style="width:350px;"tabindex="6">
                    <?php if(is_array($type_list['name'])): $i = 0; $__LIST__ = $type_list['name'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo); ?>" <?php if(in_array(($vo), is_array($info["type"])?$info["type"]:explode(',',$info["type"]))): ?>selected<?php endif; ?>><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
        ...
        <div class="form-item cf">
            ...
            <div class="controls">
                <label class="textarea input-large">
                    <textarea name="play_strategy"><?php echo ($info["play_strategy"]); ?></textarea>
                </label>
            </div>
        </div>
        ...
        <div class="form-item cf">
            ...
            <div class="controls">
                <label class="textarea input-large">
                    <textarea name="sper_capita"><?php echo ($info["sper_capita"]); ?></textarea>
                </label>
            </div>
        </div>
        ...
        <div class="form-item cf">
            ...
            <div class="controls">
                <input type="number" class="text input-large price" name="price" value="<?php echo ($info["price"]); ?>">
            </div>
        </div>
        ...
        <?php if(is_array($vip_list)): $i = 0; $__LIST__ = $vip_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="form-item cf">
                <label class="item-label">((%折)/人)<?php echo ($vo["name"]); ?>价<span class="check-tips">(0：无vip价)</span></label>
                <div class="controls">
