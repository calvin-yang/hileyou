...
<body>
    ...
    <!-- <form action="/index.php?s=/home/site_logo.html" method="post" class="form-horizontal" enctype="multipart/from-data"> -->
    <form action="/index.php?s=/home/site_logo.html" method="post" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div id="main">
                   <div class="demo">
                        <div class="btn">
                            ...
                            <span class="img_up"><input type="file" name="img" upUrl="<?php echo U('Home/imgUplode');?>" at="img_url" onchange="img_upload(this,1);"></span>
                            <input id="img_url" type="hidden" name="img_url" value="<?php echo ($info["img_url"]); ?>" />
                            <input type="hidden" name="id" value="<?php echo ($info["id"]); ?>" />
                            <input type="hidden" name="type" value="<?php echo ((isset($info["type"]) && ($info["type"] !== ""))?($info["type"]):6); ?>" />
                        </div>
                        <div class="progress">
                   ...
                   <?php $img_url = getImgUrl($info['img_url']); ?>
        ...
        <div class="form-item cf">
            ...
            <div class="controls">
                <div class="radio">
                  ...
                  <label>
                    <input type="radio" name="status" id="status" value="1" <?php if($info['status'] == '' || $info['status'] == 1): ?>checked<?php endif; ?>>
                    &nbsp;启用
                  </label>&nbsp;&nbsp;&nbsp;&nbsp;
                </div>
    ...
    <script type="text/javascript">
        ...
        //导航高亮
        $('.side-sub-menu').find('a[href="<?php echo U('Home/site_logo');?>"]').closest('li').addClass('current');
        // 然后在select元素上启用chose
