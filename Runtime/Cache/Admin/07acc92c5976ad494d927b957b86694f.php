...
<body>
    ...
    <form action="/index.php?s=/product/pyadd.html" method="post" class="form-horizontal">
        ...
        <div class="form-item cf">
            ...
            <div class="">
                <select  id="type" name="type" class="chzn-select" multiple style="width:350px;"tabindex="6">
                    <?php if(is_array($type_list['name'])): $i = 0; $__LIST__ = $type_list['name'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo); ?>"><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
