...
<body>
    ...
    <div class="header">
        ...
        <ul class="main-nav">
            ...
            <li <?php if(CONTROLLER_NAME == 'Finance'): ?>class="current"<?php endif; ?>><a href="<?php echo U('Finance/index');?>">财务</a></li>
        </ul>
        <!-- /主导航 -->
            ...
            <div id="subnav" class="subnav">
                <?php if(CONTROLLER_NAME == 'User'): ?><h3><i class="icon icon-unfold"></i>账户管理</h3>
                    <ul class="side-sub-menu">
                        ...
                        <!-- <li class="">
                            <a class="item" href="<?php echo U('user/tradingpassword');?>">修改交易密码</a>
                        </li> -->
                        <li class="">
                            <a class="item" href="<?php echo U('user/alipay');?>">绑定支付宝帐号</a>
                        </li>
                    </ul>
                ...
                <?php elseif(CONTROLLER_NAME == 'Order'): ?>
                    ...
                    <ul class="side-sub-menu">
                        ...
                        <li class="">
                            <a class="item" href="<?php echo U('Order/finanordlist');?>">提现订单</a>
                        </li>
                    </ul>
                ...
                <?php elseif(CONTROLLER_NAME == 'Finance'): ?>
                    <h3><i class="icon icon-unfold"></i>账户管理</h3>
                    <ul class="side-sub-menu">
                        <li class="">
                            <a class="item" href="<?php echo U('finance/index');?>">我的交易</a>
                        </li>
                    </ul><?php endif; ?>
            </div>
	...
	<div class="cf">
		<div class="fl">
            <a class="btn" href="<?php echo U('ProList/rmadd');?>">新 增</a>
            <button class="btn ajax-post" url="<?php echo U('ProList/rm_changeStatus',array('method'=>'resumeUser'));?>" target-form="ids">上 架</button>
            <button class="btn ajax-post" url="<?php echo U('ProList/rm_changeStatus',array('method'=>'forbidUser'));?>" target-form="ids">下 架</button>
            <button class="btn ajax-post confirm" url="<?php echo U('ProList/rm_changeStatus',array('method'=>'deleteUser'));?>" target-form="ids">删 除</button>
        </div>
        ...
        <div class="search-form fr cf">
			<div class="sleft">
				...
				<a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('ProList/rmlist');?>"><i class="btn-search"></i></a>
			</div>
		</div>
    ...
    <tbody>
		<?php if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td height="100px"><img src="<?php echo ($img_url[0]['url'])?$img_url[0]['url']:'';?>" width='100px';height='100px'></td>
			...
			<td>
				<a href="<?php echo U('ProList/rmedit?id='.$vo['id']);?>" target="_blank">编辑</a>
				<?php if($vo['status'] == '0'): ?><a href="<?php echo U('ProList/rm_changeStatus?method=resumeUser&id='.$vo['id']);?>" class="ajax-get">上架</a>
				<?php elseif($vo['status'] == '1'): ?>
					<a href="<?php echo U('ProList/rm_changeStatus?method=forbidUser&id='.$vo['id']);?>" class="ajax-get">下架</a><?php endif; ?>
				<a href="<?php echo U('ProList/rm_changeStatus?method=deleteUser&id='.$vo['id']);?>" class="confirm ajax-get">删除</a>
    ...
    //导航高亮
    $('.side-sub-menu').find('a[href="<?php echo U('ProList/rmlist');?>"]').closest('li').addClass('current');
	</script>
