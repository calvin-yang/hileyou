...
<head>
	...
	<style>
		...
		.fa_top span.btn{margin-left: 20px; float:right;}
		.fa_top p.price{margin: 15px 25px;font-size: 18px;}
		.fa_jiao {
				display: block;
			    width: 100%;
			    height: 30px;
		...
		.fa_jiao p{line-height: 30px;margin-left: 25px;font-size: 18px;}
	</style>
...
<body>
    ...
    <div class="data-table table-striped">
    	<div class="fa_top">
    		<p class="price">我的资金(￥)：<span><?php echo $price?$price:'0.00';?></span><a href="<?php echo U('Finance/withdrawals');?>"><span class="btn">提现</span></a></p>
    	</div>
    	<div class="fa_jiao">
    		<p>交易记录</p>
    	</div>
    ...
    //导航高亮
    $('.side-sub-menu').find('a[href="<?php echo U('finance/index');?>"]').closest('li').addClass('current');
	</script>
