...
<body>
	...
	<!-- 标题栏 -->
		...
		<li class="current"><a href="<?php echo U('alipay');?>">绑定支付宝</a></li>
		</ul>
		<div class="tab-content">
	<!-- 修改密码表单 -->
    <form action="<?php echo U('User/alipay');?>" method="post" class="form-horizontal" autocomplete="off">
		<div class="form-item">
			<label class="item-label">支付宝姓名：<span class="check-tips"></span></label>
			<div class="controls">
				<input type="text" name="account_name" class="text input-large" value="<?php echo ($info["account_name"]); ?>"  autocomplete="off"/>
			</div>
		</div>
		<div class="form-item">
			<label class="item-label">支付宝帐号：<span class="check-tips"></span></label>
			<div class="controls">
				<input type="text" name="back_card" class="text input-large" autocomplete="off" value="<?php echo ($info["back_card"]); ?>"/>
			</div>
		</div>
		<div class="form-item">
