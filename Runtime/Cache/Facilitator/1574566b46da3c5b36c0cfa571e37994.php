...
<html lang="en">
    <head>
        <meta charset="UTF-8">
        <title>欢迎您登录海乐游</title>
        <link rel="stylesheet" type="text/css" href="/Public/Facilitator/css/login.css" media="all">
            ...
            <div class="login-body">
                <div class="login-main pr">
                    <form action="<?php echo U('login');?>" method="post" class="login-form">
                        <h3 class="welcome"><i class="login-logo"></i>服务商管理平台</h3>
                        <div id="itemBox" class="item-box">
                            <div class="item">
                                <i class="icon-login-user"></i>
                                <input type="text" name="username" placeholder="请填写手机号" autocomplete="off" />
                            </div>
                            <span class="placeholder_copy placeholder_un">请填写手机号</span>
                            <div class="item b0">
